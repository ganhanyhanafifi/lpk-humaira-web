export const pagesContent = {
  ...
  '/profile/company/izin-so': {
    ...
    heroTitle: 'Legalitas dan Izin Resmi',
    heroSubtitle: 'Terdaftar Sebagai Sending Organization yang Sah',
    sections: [
      {
        title: 'Status Legal',
        content: '<p>LPK Humaira Institute telah resmi terdaftar dan mengantongi izin dari Kementerian Ketenagakerjaan Republik Indonesia serta instansi terkait lainnya sebagai Sending Organization (S.O) yang sah untuk memberangkatkan peserta magang dan pekerja migran.</p><p>Dengan legalitas ini, kami memastikan keamanan dan perlindungan hukum bagi setiap peserta pelatihan kami.</p>'
      }
    ]
  },
  '/profile/company/our-team': {
    title: 'Our Team',
    metaDescription: 'Tim Instruktur dan Manajemen LPK Humaira',
    heroTitle: 'Tim Profesional Kami',
    heroSubtitle: 'Didukung oleh Para Ahli dan Praktisi Berpengalaman',
    sections: [
      {
  ...
  '/profile/company/lokasi': {
    title: 'Lokasi Pendidikan & Pelatihan',
    metaDescription: 'Lokasi pusat pelatihan LPK Humaira',
    heroTitle: 'Pusat Pendidikan & Pelatihan',
    heroSubtitle: 'Fasilitas Belajar yang Nyaman dan Modern',
    sections: [
      {
        title: 'Fasilitas Pendidikan',
        content: '<p>Pusat pelatihan kami dirancang untuk mendukung proses belajar mengajar yang interaktif dan efektif, dilengkapi dengan ruang kelas ber-AC, perpustakaan, dan area simulasi kerja.</p><p>Lokasi kami strategis dan mudah diakses, memberikan kenyamanan maksimal bagi para siswa yang mengikuti program intensif.</p>'
      }
    ]
  },
  '/profile/company/alamat': {
    title: 'Alamat Kantor Pusat',
    metaDescription: 'Alamat Kantor Pusat LPK Humaira Institute',
    heroTitle: 'Kantor Pusat Kami',
